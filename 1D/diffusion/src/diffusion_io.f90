!******************************************************************************
! MODULE DIFFUSION_IO: io for advection module
!******************************************************************************
module diffusion_io
  use io_helpers
  use globals
  ...
  contains
    ...
    subroutine write_conv(state, state_ref, folder, suffix_in)
      ...
      real(dp), dimension(ncells_ref+2*ngcells), intent(in) :: state_ref
